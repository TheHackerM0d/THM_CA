...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          StyleColorsBlueDark(ImGuiStyle* dst = NULL);    // new, recommended style (default)
    IMGUI_API void          StyleColorsPurpleDark(ImGuiStyle* dst = NULL); // classic imgui style
    IMGUI_API void          StyleColorsSuperMan(ImGuiStyle* dst = NULL); // classic imgui style
