...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Blue Dark\0Light\0Purple Dark"))
    {
        switch (style_idx)
        {
            case 0: ImGui::StyleColorsBlueDark(); break;
            case 1: ImGui::StyleColorsLight(); break;
            case 2: ImGui::StyleColorsPurpleDark(); break;
        }
        return true;
    }
    return false;
